/*
  ...
  - You are about to drop the column `teacherId` on the `Reservation` table. All the data in the column will be lost.
...
INSERT INTO "new_Reservation" ("createdAt", "device_id", "device_name", "id", "refunded", "refundedAt", "reservation_quantity", "updatedAt") SELECT "createdAt", "device_id", "device_name", "id", "refunded", "refundedAt", "reservation_quantity", "updatedAt" FROM "Reservation";
